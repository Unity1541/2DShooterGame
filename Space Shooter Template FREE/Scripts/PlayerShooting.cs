...
//當你在 PlayerShooting 這個MonoBehaviour中宣告public Guns guns時，因為 Guns 類別使用了 [System.Serializable] 標籤，Guns 類別的內容會顯示在 Unity 的 Inspector 中。這樣你可以直接在 Inspector 內編輯 Guns 的屬性（如 rightGun、leftGun 和 centralGun），
//將其視為一組參數進行管理。這種做法能讓類別成為可視化的欄位，方便設定相關的物件參考。
public class PlayerShooting : MonoBehaviour {
    ...
    [Range(1, 4)]   //這邊設定武器的等級，然後在Switch case來變動
